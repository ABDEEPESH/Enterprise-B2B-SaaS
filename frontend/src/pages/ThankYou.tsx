    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 max-w-2xl mx-auto">
              <h2 className="font-semibold text-secondary-900 mb-4">What Happens Next?</h2>
              <div className="space-y-3 text-left">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="font-medium text-secondary-900">Immediate Confirmation</div>
                    <div className="text-secondary-600 text-sm">You'll receive an email confirmation shortly</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-primary-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    <div className="font-medium text-secondary-900">Expert Review</div>
                    <div className="text-secondary-600 text-sm">Our team will analyze your requirements</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-primary-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    <div className="font-medium text-secondary-900">Personalized Response</div>
                    <div className="text-secondary-600 text-sm">We'll contact you with tailored solutions</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-6">
          ...
          >
            <h2 className="text-3xl font-bold text-secondary-900 mb-4">While You Wait</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <motion.div
                ...
                className="bg-gradient-to-br from-primary-50 to-secondary-50 rounded-xl p-6 hover:shadow-lg transition-shadow duration-300"
              >
                <h3 className="font-semibold text-secondary-900 mb-3">{resource.title}</h3>
                <p className="text-secondary-600 mb-4 text-sm">{resource.description}</p>
      ...
      <section className="py-16 bg-secondary-50">
        <div className="container mx-auto px-6">
          ...
          >
            <h2 className="text-3xl font-bold text-secondary-900 mb-8 text-center">Need Immediate Assistance?</h2>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white rounded-xl p-6 text-center hover:shadow-lg transition-shadow duration-300">
                ...
                <p className="text-secondary-600 text-sm mb-4">Speak directly with our team</p>
              ...
              <div className="bg-white rounded-xl p-6 text-center hover:shadow-lg transition-shadow duration-300">
                ...
                <p className="text-secondary-600 text-sm mb-4">Get in touch via email</p>
              ...
              <div className="bg-white rounded-xl p-6 text-center hover:shadow-lg transition-shadow duration-300">
                ...
                <p className="text-secondary-600 text-sm mb-4">Chat with our support team</p>
